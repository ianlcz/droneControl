...
const Commands = (props) => (
  <CommandGrid>
    ...
    <div className="container pan">
      ...
      <div className="button">
        <button className="flipL" onClick={sendCommand("flip l")}>
          <span className="symbol">
            <GiRapidshareArrow />
          </span>
        </button>
        <button className="flipB" onClick={sendCommand("flip b")}>
          <span className="symbol">
            <GiRapidshareArrow />
          </span>
        </button>
        <button className="goGo" onClick={sendCommand("go 25 25 25 25")}>
          <span className="symbol">
            <GiWingedArrow />
          </span>
        </button>
        ...
        <button className="flipF" onClick={sendCommand("flip f")}>
          <span className="symbol">
            <GiRapidshareArrow />
          </span>
        </button>
        <button className="flipR" onClick={sendCommand("flip r")}>
          <span className="symbol">
            <GiRapidshareArrow />
          </span>
        </button>
